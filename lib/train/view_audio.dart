...
class Audio extends StatefulWidget {
  final TrainingaudiobookData fileaudio;
  const Audio({Key? key, required this.fileaudio}) : super(key: key);
...
class _AudioState extends State<Audio> {
  ...
  Future<void> _init() async {
      showfileAudio = widget.fileaudio;
     final url = '${showfileAudio.message.file}';
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('${showfileAudio.message.name}'),
      ),
      body: SafeArea(
        child: Padding(
                    ...
                    child: Column(
                      children: [
                        ListTile(
                          ...
                          title: Text(
                            '${showfileAudio.message.name}',
                            style: TextStyle(fontSize: 18),
                          ),
                          subtitle: Text(
                            ' จาก : ${showfileAudio.message.author} ',
                            style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Text(
                            'รายละเอียด : ${showfileAudio.message.details}',
                            style:
                        ...
                        //   ],
                        // ),
                        // Image.network(showfileAudio.picture),
                      ],
                    ),
                  ),
              Container(
  ...
  late TrainingaudiobookData showfileAudio;

  // Future<void> pay() async {
  //   showfileAudio = widget.fileaudio;
  //   await player.setUrl('${showfileAudio.file}');
  //   player.play();
  // }
...
//   late AudioPlayer _player;
//   final url = 'https://addpaycrypto.com/mdes_new/backoffice/management_audiobook/file_audiobook/เข็นครกตัวเบา บทความ ความล้าสมัยของคนเฒ่าไฮเทค_414c84da396b7ef5cccfa0bb7d75336d.02';
//   late Stream<DurationState> _durationState;
//   var _isShowingWidgetOutline = false;
//   var _labelLocation = TimeLabelLocation.below;
//   var _labelType = TimeLabelType.totalTime;
